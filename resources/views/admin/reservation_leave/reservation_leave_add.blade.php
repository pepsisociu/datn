...
{{--            </div>--}}
    ...
    {{--                        </li>--}}
                    ...
                    @if(auth()->user()->role->name === Config::get('auth.roles.doctor'))
                        ...
                        <li class="nav-item">
                            <a href="{{ URL::to(route('admin.reservation_leave.create')) }}" class="nav-link active">
                                <i class="nav-icon fas fa-calendar-alt"></i>
                                <p>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            ...
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form id="quickForm" action="{{ URL::to(route('admin.reservation_leave.store')) }}" enctype="multipart/form-data" method="POST">
                                @csrf
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group date" id="reservationdate" data-target-input="nearest">
                                            ...
                                            <input type="text" name="date" required class="form-control datetimepicker-input" data-target="#reservationdate"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="bootstrap-timepicker">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group date" id="startPicker" data-target-input="nearest">
                                                    ...
                                                    <input type="text" name="startTime" required class="form-control datetimepicker-input" data-target="#startPicker"/>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="bootstrap-timepicker">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group date" id="endPicker" data-target-input="nearest">
                                                    ...
                                                    <input type="text" name="endTime" required class="form-control datetimepicker-input" data-target="#endPicker"/>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
