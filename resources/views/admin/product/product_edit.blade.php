                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            ...
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form id="quickForm" action="{{ URL::to(route('admin.product.update', ['product'=>$product->id])) }}"
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="name" class="form-control" placeholder="Enter name product" value="{{ $product->name }}">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <textarea class="form-control" name="short_description" rows="2" placeholder="Enter short description">{{$product->short_description}}</textarea>
                                        </div>
                                    <div class="form-group">
                                        <label>Image</label>
                                        <div class="input-group">
                                    ...
                                    <div class="form-group row pt-3">
                                        <div class="col-md-6">                                        
                                            <div class="custom-control custom-switch">
                                                <input type="checkbox" name="active" class="custom-control-input" id="customSwitch1" @if ($product->active) checked @endif>                                         
