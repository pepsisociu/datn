                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="name" class="form-control" placeholder="Enter name product" value="{{ $product->name }}" disabled>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" name="price" class="form-control" placeholder="Enter price" value="{{$product->price}}" disabled>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <textarea class="form-control" name="short_description" rows="2" placeholder="Enter short description" disabled>{{$product->short_description}}</textarea>
                                        </div>
                                    </div>
                                    @if($product->image){}
                                    <div class="form-group">
